...
Le premier challenge est simplement de la configuration afin de pouvoir réaliser correctement les challenges. On suit donc les étapes du challenge. [Rappel du faucet utilisé](https://faucet.egorfine.com/).